  ...
  return (
    ...
    <div className="w-screen relative h-screen flex justify-center items-center align-middle">
      <Aurora
        ...
        speed={0.5}
      />
      <div className="absolute md:w-3/4 w-5/6 z-20 backdrop-blur-md flex md:p-5 md:h-4/5 md:py-0 py-10 align-middle items-center rounded-3xl bg-[#6a69691e] overflow-hidden">
