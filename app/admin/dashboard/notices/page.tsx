...
export default function noticesPage() {
  ...
  const handleNewNoticeSubmit = async () => {
    ...
    // try {
    //   const res = await noticeHandler("notice", "POST");
    //   if (res) {
                    ...
                    <div className="flex space-x-4 items-center">
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => setNewNotice({ ...newNotice, type: e.target.value as 'Notice' | 'Circular' })}
                          className="text-green-500 focus:ring-green-500 bg-gray-800 border-gray-700"
                        />
                        <Label htmlFor="notice" className="flex items-center gap-1">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="circular" className="flex items-center gap-1">
